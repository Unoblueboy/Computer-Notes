...
\subsection{Structure and Role of the Processor and its Components} \noindent
  ...
  \end{itemize}
  \marginnote{4.7.3.6}Interrupts are signals sent by an external source or program to the processor, usually to request the processor to start doing something. Some examples are:
  \begin{itemize}
