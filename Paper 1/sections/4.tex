...
\subsection{A model of computation}
  ...
  \begin{itemize}
  	...
  	\item A finite state machine
	  	...
	  	\draw[->, line width=2pt] (S0.north east) .. controls ([xshift=20pt,yshift=20pt]S0.north east) and ([xshift=-20pt,yshift=20pt]S0.north west) .. node[above] {0/0,L} (S0.north west);
	  	\draw[->, line width=2pt] (S0.south west) .. controls ([xshift=-20pt,yshift=-20pt]S0.south west) and ([xshift=20pt,yshift=-20pt]S0.south east) .. node[below] {0/0,L} (S0.south east);
