...
\subsection{The Transmission Control Protocol/ Internet Protocol (TCP/IP) protocol}
  \noindent
  \marginnote{4.9.3.1}TCP/IP
  
  \noindent
  \marginnote{4.9.3.1}Standard application layer protocols
  
  \noindent
  \marginnote{4.9.3.1}IP address structure
  
  \noindent
  \marginnote{4.9.3.1}Subnet masking
  
  \noindent
  \marginnote{4.9.3.1}IP standards
  
  \noindent
  \marginnote{4.9.3.1}Public and Private IP addresses
